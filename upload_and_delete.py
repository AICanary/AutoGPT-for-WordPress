...
#The os.walk() function yields a 3-tuple for each directory it visits,
# which includes the current directory path (subdir),
# a list of subdirectory names in that directory (dirnames),
# and a list of filenames in that directory (filenames).
# The for loop iterates over each of these 3-tuples,
# allowing you to perform operations on the directories
# and files as you traverse through them.
...
#             source_folder = articles_dir/
            source = os.path.join(subdir)
            print("source folder to move                      :",source )
            destination = os.path.join( "./backups", subdir)
            print("destination folder to  move to             :",source )
